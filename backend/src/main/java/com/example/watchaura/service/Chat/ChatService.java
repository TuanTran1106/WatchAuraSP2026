...
//
//
//    @Value("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")
...
public class ChatService {
    ...
    private String callGroqAPI(String userMessage) throws Exception {
        ...
        requestBody.put("max_tokens", 800); // tăng lên vì câu trả lời sản phẩm cần dài hơn
        requestBody.put("temperature", 0.7);

        //THAY ĐỔI CHÍNH: lấy system prompt động từ DB
        String systemPrompt = chatbotDataService.buildSystemPrompt();
